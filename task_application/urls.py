...
from task.views import IndexView, LoginView, RegistrationView, SignupView, TaskAddView, TaskListView, TaskDetailView, TaskDeleteView, RegistrationView, LoginView
